      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <div className="relative h-full flex items-center justify-center p-12">
          <div className="max-w-md text-white">
            ...
            <Link
              to="/captain-signup"
              className="inline-flex items-center px-6 py-3 border border-white rounded-lg text-white font-medium hover:bg-white hover:text-black hover:bg-opacity-10 transition-colors duration-200"
            >
              Sign up to drive
              <svg
